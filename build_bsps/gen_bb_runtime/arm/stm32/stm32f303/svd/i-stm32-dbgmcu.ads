...
package Interfaces.STM32.DBGMCU is
   ...
   subtype APB1FZ_DBG_TIM2_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM3_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM4_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM5_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM6_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM7_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM12_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM13_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIMER14_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_TIM18_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_RTC_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_WWDG_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_IWDG_STOP_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_I2C1_SMBUS_TIMEOUT_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_I2C2_SMBUS_TIMEOUT_Field is Interfaces.STM32.Bit;
   subtype APB1FZ_DBG_CAN_STOP_Field is Interfaces.STM32.Bit;
   ...
   subtype APB2FZ_DBG_TIM15_STOP_Field is Interfaces.STM32.Bit;
   subtype APB2FZ_DBG_TIM16_STOP_Field is Interfaces.STM32.Bit;
   subtype APB2FZ_DBG_TIM17_STO_Field is Interfaces.STM32.Bit;
   subtype APB2FZ_DBG_TIM19_STOP_Field is Interfaces.STM32.Bit;
