...
package Interfaces.STM32.EXTI is
   ...
   type IMR2_Register is record
      ...
      --  unspecified
      Reserved_4_31 : Interfaces.STM32.UInt28 := 16#FFFFFFF#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RTSR2_TR_Element is Interfaces.STM32.Bit;
   ...
   subtype FTSR2_TR_Element is Interfaces.STM32.Bit;
   ...
   subtype SWIER2_SWIER_Element is Interfaces.STM32.Bit;
   ...
   subtype PR2_PR_Element is Interfaces.STM32.Bit;
