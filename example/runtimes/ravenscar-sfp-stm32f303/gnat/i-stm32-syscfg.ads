...
package Interfaces.STM32.SYSCFG is
   ...
   subtype CFGR1_USB_IT_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM1_ITR_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_DAC_TRIG_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_ADC24_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM16_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM17_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM6_DAC1_DMA_RMP_Field is Interfaces.STM32.Bit;
   subtype CFGR1_TIM7_DAC2_DMA_RMP_Field is Interfaces.STM32.Bit;
   ...
   subtype CFGR1_I2C1_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_I2C2_FM_Field is Interfaces.STM32.Bit;
   subtype CFGR1_ENCODER_MODE_Field is Interfaces.STM32.UInt2;
   subtype CFGR1_FPU_IT_Field is Interfaces.STM32.UInt6;
   ...
   subtype RCR_PAGE0_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE1_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE2_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE3_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE4_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE5_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE6_WP_Field is Interfaces.STM32.Bit;
   subtype RCR_PAGE7_WP_Field is Interfaces.STM32.Bit;
   ...
   subtype CFGR2_BYP_ADD_PAR_Field is Interfaces.STM32.Bit;
